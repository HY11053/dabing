                ...
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <div class="pull-right" style="display:inline-block; width: 210px">
                            <a href="{{action('Admin\ArticleController@Create')}}" style="color: #ffffff ; display: inline-block; padding-left: 3px;"><button  class="btn btn-sm btn-default bg-blue"><i class="fa  fa-pencil-square" style="padding-right: 3px;"></i>小程序首页模板添加</button></a>
                        </div>
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($applists as $applist)
                            <tr>
                                ...
                                <td>{{$applist->write}}</td>
                                <td>{{$applist->click}}</td>
                                <td class="astyle"><span class="label label-success"><a href="/news/{{$applist->id}}.shtml" target="_blank">预览</a></span><span class="label label-warning"><a href="/admin/article/edit/{{$applist->id}}">编辑</a></span><span class="label label-danger"><a data-toggle="modal" data-target=".modal-sm{{$applist->id}}" >删除</a></span>
