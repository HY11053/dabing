...
@section('title')小程序单页模板内容修改@stop
@section('head')
...
@section('content')
    <!-- row -->
    <div class="row">
        {{Form::model($appletsign,array('route' =>array( 'wxsign_update','id'=>$appletsign->id),'method' => 'put','files' => true,))}}
        <div class="col-md-12">
            <!-- The time line -->
            <ul class="timeline">
                <!-- timeline time label -->
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-body">
                            <div class="col-md-4 col-sm-12 col-xs-12">
                                <img src="{{ $appletsign->litpic }}" class="img-rounded img-responsive"/>
                            </div>
