...
@section('title')小程序固定模板内容添加@stop
@section('head')
...
@section('content')
    <!-- row -->
    <div class="row">
        {{Form::open(array('route' => 'fixedtemplatecreate','files' => true,))}}
        <div class="col-md-12">
            <!-- The time line -->
            <ul class="timeline">
                <!-- timeline time label -->
                ...
                <li>
                    ...
                    <div class="timeline-item">
                        ...
                        <h3 class="timeline-header"><a href="#">小程序固定模板基本信息|</a> 按需填写</h3>
    ...
    <script>
        $(function () {
            $("#input-image-1,#input-image-2,#input-image-3,#input-image-4").fileinput({
                ...
                $('#kv-success-box'+field).html('上传成功！');
                $('#kv-success-modal-'+field).modal('show');
                $('#kv-success-modal-'+field+' .kv-file-remove').hide();
